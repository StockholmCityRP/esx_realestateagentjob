...
TriggerEvent('esx_society:registerSociety', 'realestateagent', 'Real estate agent', 'society_realestateagent', 'society_realestateagent', 'society_realestateagent', {type = 'private'})
